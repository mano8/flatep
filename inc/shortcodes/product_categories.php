...
function flatep_product_categories($atts, $content = null, $tag) {
  $sliderrandomid = rand();
  extract( shortcode_atts( array (
	...
	ob_start();
    $is_meta_years = ($show_years && get_theme_mod( 'flatep_wc_add_cat_meta_years', true )) ? true : false;
    ...
    if ( $product_categories ) {
      foreach ( $product_categories as $category ) {
        ...
        $classes_col = array('product-category','col','flatep-wc-ux-cat');
              ...
              <?php do_action( 'woocommerce_before_subcategory', $category ); ?>
                ...
                <div class="box-text <?php echo implode(' ', $classes_text); ?>" <?php echo get_shortcode_inline_css($css_args); ?>>
                  <div class="box-text-inner">
                      ...
                      ?>
                            <p class="uppercase count tep-meta-years">
                              <?php echo esc_attr($productCatMetaYears) ?>
                            </p>
...
add_shortcode("ux_product_categories", "flatep_product_categories");
add_shortcode("ux_product_categories_grid", "flatep_product_categories");
