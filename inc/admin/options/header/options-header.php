...
include_once(dirname( __FILE__ ).'/tep-header-top.php');
include_once(dirname( __FILE__ ).'/tep-header-main.php');
include_once(dirname( __FILE__ ).'/tep-header-bottom.php');

function tep_refresh_header_partials( WP_Customize_Manager $wp_customize ) {
  ...
  if ( ! isset( $wp_customize->selective_refresh ) ) {
	...
	$wp_customize->selective_refresh->add_partial( 'header_top', array(
	    'selector' => '#top-bar',
	    'settings' => array('top_bar_tep_sel_active_pages', 'top_bar_tep_actived_pages', 'header_mobile_elements_top','topbar_elements_center', 'topbar_elements_right', 'topbar_elements_left','nav_style_top'),
	...
	$wp_customize->selective_refresh->add_partial( 'header_bottom', array(
	    'selector' => '#wide-nav',
	    'settings' => array('bottom_bar_tep_sel_active_pages','bottom_bar_tep_actived_pages','nav_style_bottom','nav_spacing_bottom','nav_size_bottom','header_mobile_elements_bottom','header_elements_bottom_left', 'header_elements_bottom_center', 'header_elements_bottom_right'),
	    'container_inclusive' => true,
	    'render_callback' => function() {
	...
	$wp_customize->selective_refresh->add_partial( 'header_elements_right', array(
	    ...
	    'render_callback' => function() {
	        flatep_header_elements('header_elements_right');
	    },
	) );
	...
	$wp_customize->selective_refresh->add_partial( 'header_elements_left', array(
	    ...
	    'render_callback' => function() {
	        flatep_header_elements('header_elements_left');
	    },
	) );
	...
	$wp_customize->selective_refresh->add_partial( 'mobile-sidebar', array(
	    ...
	    'render_callback' => function() {
	        flatep_header_elements('mobile_sidebar','sidebar');
	    },
	) );
	...
	$wp_customize->selective_refresh->add_partial( 'header_mobile_elements_left', array(
	    ...
	    'render_callback' => function() {
	        flatep_header_elements('header_mobile_elements_left','mobile');
	    },
	) );
	...
	$wp_customize->selective_refresh->add_partial( 'header_mobile_elements_right', array(
	    ...
	    'render_callback' => function() {
	        flatep_header_elements('header_mobile_elements_right','mobile');
	    },
	) );
...
remove_action( 'customize_register', 'flatsome_refresh_header_partials' );
add_action( 'customize_register', 'tep_refresh_header_partials', 10 );